...
<WebServiceRequestEntity>
   <description>Get all user from ReqresAPI page 1</description>
   <name>GET List Users</name>
   <tag></tag>
   <elementGuidId>6eae10d7-5397-43a2-b038-d1341b34390d</elementGuidId>
...
WS.verifyElementPropertyValue(response, 'data[1].first_name', 'Janet')</verificationScript>
